...
namespace Drupal\islandora_file_transmission_fixity\Form;
...
class FixitySettingForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'islandora_file_transmission_fixity_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return [
      'islandora_file_transmission_fixity.settings',
    ];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('islandora_file_transmission_fixity.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('islandora_file_transmission_fixity.settings')
